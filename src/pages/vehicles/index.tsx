...
export function VehicleListPage(props: VehicleListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getVehicles({
        relations: ['company', 'reservation.count', 'usage.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['info.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'info', header: 'Info', accessorKey: 'info' },
    ...
    hasAccess('reservation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('usage', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'usage',
          header: 'Usage',
          accessorKey: 'usage',
          cell: ({ row: { original: record } }: any) => record?._count?.usage,
        }
      : null,
